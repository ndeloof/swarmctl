...
import (
	...
	"github.com/moby/swarmctl/cmd/stack/loader"
	"github.com/moby/swarmctl/cmd/stack/options"
	"github.com/moby/swarmctl/cmd/stack/swarm"
...
func newDeployCommand(dockerCli command.Cli) *cobra.Command {
	...
	flags.SetAnnotation("compose-file", "version", []string{"1.25"}) //nolint: errcheck
	...
	flags.SetAnnotation("prune", "version", []string{"1.27"}) //nolint: errcheck
	...
	flags.SetAnnotation("resolve-image", "version", []string{"1.30"}) //nolint: errcheck
	return cmd
}
